...
export default function EditTempEmployee({ tempEmployee, onClose, onUpdateTempEmployee, branches }) {
  ...
  useEffect(() => {
    if (tempEmployee) {
      ...
      setFormData({
        ...tempEmployee,
        doj: formatDate(tempEmployee.doj),
        qidExpiry: formatDate(tempEmployee.qidExpiry),
        passportExpiry: formatDate(tempEmployee.passportExpiry),
        medicalCardExpiry: formatDate(tempEmployee.medicalCardExpiry)
      });
      
      if (tempEmployee.documents) {
        setUploadedDocuments(tempEmployee.documents);
      }
    }
  }, [tempEmployee]);
  ...
  const handleSubmit = async (e) => {
    ...
    const tempEmployeeData = {
      ...formData,
      documents: {
        qidCopy: uploadedDocuments.qidFile || uploadedDocuments.qidCopy || null,
        passportCopy: uploadedDocuments.passportFile || uploadedDocuments.passportCopy || null,
        medicalCard: uploadedDocuments.medicalCardFile || uploadedDocuments.medicalCard || null,
        workAgreement: uploadedDocuments.workAgreementFile || uploadedDocuments.workAgreement || null,
        profilePicture: uploadedDocuments.profilePictureFile || uploadedDocuments.profilePicture || null
      }
    };
    
    await onUpdateTempEmployee(tempEmployeeData);
    onClose();
  };
  ...
  return (
    <div className="bg-white p-6 rounded-lg max-h-[90vh] overflow-y-auto">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-xl font-semibold text-gray-900">Edit Temporary Employee</h2>
        ...
        <div className="border-t pt-4">
          ...
          <div className="flex space-x-2">
            <input
              ...
              className="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded file:border-0 file:text-sm file:bg-orange-50 file:text-orange-700"
            />
            <button
              type="button"
          ...
          {(uploadedDocuments.profilePictureFile || uploadedDocuments.profilePicture) && (
            <div className="mt-1 text-xs text-green-600">
              ✓ Current: {(uploadedDocuments.profilePictureFile || uploadedDocuments.profilePicture)?.fileName}
            </div>
          )}
        </div>
        ...
        <div className="border-t pt-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
            ...
            <div>
              ...
              {(uploadedDocuments.qidFile || uploadedDocuments.qidCopy) && (
                <div className="mt-1 text-xs text-green-600">
                  ✓ Current: {(uploadedDocuments.qidFile || uploadedDocuments.qidCopy)?.fileName}
                </div>
              )}
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
            ...
            <div>
              ...
              {(uploadedDocuments.passportFile || uploadedDocuments.passportCopy) && (
                <div className="mt-1 text-xs text-green-600">
                  ✓ Current: {(uploadedDocuments.passportFile || uploadedDocuments.passportCopy)?.fileName}
                </div>
              )}
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
            ...
            <div>
              ...
              {(uploadedDocuments.medicalCardFile || uploadedDocuments.medicalCard) && (
                <div className="mt-1 text-xs text-green-600">
                  ✓ Current: {(uploadedDocuments.medicalCardFile || uploadedDocuments.medicalCard)?.fileName}
                </div>
              )}
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div>
              ...
              {(uploadedDocuments.workAgreementFile || uploadedDocuments.workAgreement) && (
                <div className="mt-1 text-xs text-green-600">
                  ✓ Current: {(uploadedDocuments.workAgreementFile || uploadedDocuments.workAgreement)?.fileName}
                </div>
              )}
            </div>
          </div>
