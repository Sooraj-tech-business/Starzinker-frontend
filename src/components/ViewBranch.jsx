  ...
  useEffect(() => {
    const fetchTempEmployees = async () => {
      ...
      try {
        ...
        setTempEmployees(response.data.employees || []);
      } catch (error) {
        ...
        {tempEmployees.length > 0 && (
          <div className="mt-8 bg-gray-50 rounded-lg p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center">
              ...
              Temporary Employees ({tempEmployees.length})
            </h3>
            <div className="overflow-x-auto bg-white rounded-lg shadow">
              <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-orange-50">
                  <tr>
                    ...
                    <th className="px-6 py-3 text-left text-xs font-medium text-orange-700 uppercase tracking-wider">Role</th>
                    <th className="px-6 py-3 text-left text-xs font-medium text-orange-700 uppercase tracking-wider">Email</th>
                    <th className="px-6 py-3 text-left text-xs font-medium text-orange-700 uppercase tracking-wider">Salary</th>
                ...
                <tfoot className="bg-gray-50">
                  <tr>
                    <td colSpan="3" className="px-6 py-3 text-sm font-medium text-gray-700">Total Temp Salary:</td>
                    <td className="px-6 py-3 text-sm font-bold text-green-600">
                      {tempEmployees.reduce((sum, emp) => sum + (emp.salary || 0), 0).toLocaleString()} QR
                    </td>
                    <td className="px-6 py-3"></td>
                  </tr>
                </tfoot>
